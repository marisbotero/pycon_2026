...
3. Consulta la [guía del código Python](taller_agentes/GUIA_CODIGO.md).
4. Abre [Workshop_Agentes.ipynb](taller_agentes/Workshop_Agentes.ipynb).
5. Construye tu agente en [taller_agentes/agente](taller_agentes/agente).
